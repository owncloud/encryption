OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one. Please run 'occ encryption:migrate' or contact your administrator" : "مەخپىيلەشتۈرۈش ئاچقۇچلىرىڭىزنى كونا مەخپىيلەشتۈرۈش (ownCloud <= 8.0) دىن يېڭىسىغا كۆچۈرۈشىڭىز كېرەك. «مەخپىيلەشتۈرۈش: كۆچۈش» نى ئىجرا قىلىڭ ياكى باشقۇرغۇچىڭىز بىلەن ئالاقىلىشىڭ",
    ...
    "Can not decrypt this file, probably this is a shared file. Please ask the file owner to reshare the file with you." : "بۇ ھۆججەتنى يېشىشكە بولمايدۇ ، بەلكىم بۇ ئورتاق ھۆججەت بولۇشى مۇمكىن. ھۆججەت ئىگىسىدىن ھۆججەتنى سىز بىلەن ئورتاقلىشىشنى تەلەپ قىلىڭ.",
    "Can not read this file, probably this is a shared file. Please ask the file owner to reshare the file with you." : "بۇ ھۆججەتنى ئوقۇيالمايدۇ ، بەلكىم بۇ ئورتاق ھۆججەت بولۇشى مۇمكىن. ھۆججەت ئىگىسىدىن ھۆججەتنى سىز بىلەن ئورتاقلىشىشنى تەلەپ قىلىڭ.",
    "Hey there,\n\nthe admin enabled server-side-encryption. Your files were encrypted using the password '%s'.\n\nPlease login to the web interface, go to the section 'ownCloud basic encryption module' of your personal settings and update your encryption password by entering this password into the 'old log-in password' field and your current login-password.\n\n" : "ھەي ،\n\nباشقۇرغۇچى مۇلازىمېتىرنى مەخپىيلەشتۈرۈشنى قوزغىدى. ھۆججەتلىرىڭىز مەخپىي شىفىر '% s' ئارقىلىق شىفىرلاندى.\n\nتور كۆرۈنمە يۈزىگە كىرىڭ ، شەخسىي تەڭشەكلىرىڭىزنىڭ «ownCloud ئاساسىي مەخپىيلەشتۈرۈش مودۇلى» دېگەن بۆلەككە كىرىپ ، مەخپىي شىفىرىڭىزنى «كونا كىرىش پارولى» مەيدانىغا ۋە نۆۋەتتىكى كىرىش پارولىڭىزغا كىرگۈزۈپ مەخپىيلەشتۈرۈش پارولىڭىزنى يېڭىلاڭ.",
    "The share will expire on %s." : "بۇ ھەمبەھىر %s دا مۇددىتى توشىدۇ.",
    "Cheers!" : "پەچەت!",
    "Hey there,<br><br>the admin enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>.<br><br>Please login to the web interface, go to the section \"ownCloud basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.<br><br>" : "ھەي ، <br> <br> باشقۇرغۇچى مۇلازىمېتىرنى مەخپىيلەشتۈرۈشنى قوزغىدى. ھۆججەتلىرىڭىز مەخپىي شىفىر <strong>% s </strong> ئارقىلىق مەخپىيلەشتۈرۈلدى. بۇ پارولنى «كونا كىرىش مەخپىي نومۇرى» ۋە نۆۋەتتىكى كىرىش پارولىڭىزغا كىرگۈزۈڭ. <br> <br>",
    ...
    "Encryption type: Master Key" : "شىفىرلاش تىپى: Master Key",
    "Encryption type: User Specific Key" : "شىفىرلاش تىپى: ئىشلەتكۈچىنىڭ كونكرېت ئاچقۇچى",
    "Please select an encryption option" : "مەخپىيلەشتۈرۈش تاللانمىسىنى تاللاڭ",
    "Master Key" : "Master Key",
    "Permanently select this mode" : "بۇ ھالەتنى مەڭگۈلۈك تاللاڭ",
    "User Specific Key encryption module is deprecated. See the <a target=\"_blank\" rel=\"noreferrer\" href=\"%s\">server release notes ↗</a> for more information." : "ئىشلەتكۈچى كونكرېت ئاچقۇچ مەخپىيلەشتۈرۈش مودۇلى ۋاقتى ئۆتكەن. تېخىمۇ كۆپ ئۇچۇرغا ئېرىشىش ئۈچۈن <a target = \"_ blank\" rel = \"noreferrer\" href = \"% s\"> مۇلازىمېتىر قويۇپ بېرىش خاتىرىلىرى ↗ </a> گە قاراڭ.",
    ...
    "ownCloud basic encryption module" : "ownCloud ئاساسىي مەخپىيلەشتۈرۈش مودۇلى",
    ...
    " If you don't remember your old password you can ask your administrator to recover your files." : "كونا پارولىڭىزنى ئېسىڭىزدە تۇتمىسىڭىز باشقۇرغۇچىڭىزدىن ھۆججەتلىرىڭىزنى ئەسلىگە كەلتۈرۈشىنى تەلەپ قىلسىڭىز بولىدۇ.",
