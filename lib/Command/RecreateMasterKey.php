...
class RecreateMasterKey extends Command {
	 ...
	 */
	public function __construct(IUserManager $userManager, CustomView $rootView, KeyManager $keyManager, Util $util,
	...
	protected function decryptFile($path) {
		...
		try {
			$this->rootView->copyCustom($source, $target,false, true);
